...
const PostItem = ({deletePost,addLike, removeLike,auth: {isAuth, user: authUser}, post: {_id, text, name, avatar, user, likes, comments, date}, showActions}) => {
    return (
        <>
        <div className="post bg-white p-1 my-1">
          ...
          <div>
            ...
            <>
              ...
              {!auth.loading && user === authUser._id && (
                  <button      
                  type="button"
